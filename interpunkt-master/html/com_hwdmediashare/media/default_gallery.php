<?php
/**
 * @version    SVN $Id: default_gallery.php 224 2012-03-01 22:09:22Z dhorsfall $
 * @package    hwdMediaShare
 * @copyright  Copyright (C) 2011 Highwood Design Limited. All rights reserved.
 * @license    GNU General Public License http://www.gnu.org/copyleft/gpl.html
 * @author     Dave Horsfall
 * @since      09-Nov-2011 16:22:52
 */
	...
	<div class="row-fluid items-row cols-<?php echo (int) $this->columns;?> <?php echo 'row-'.$row ; ?>">
		...
		<div class="item column-<?php echo $rowcount;?><?php echo ($item->published != '1' ? ' system-unpublished' : false); ?> span<?php echo round((12/$this->columns));?>">
			...
			<div class="system-unpublished">
				<?php endif; ?>
				<div class="thumbnail media-item hasTip" title="<?php echo $this->escape($item->title); ?>::<?php echo $this->escape(strip_tags($tip, '<ul><li>')); ?>">
